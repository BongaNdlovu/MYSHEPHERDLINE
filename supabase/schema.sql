...
create table if not exists public.members (
  ...
  care_stage text not null default 'new' check (care_stage in ('new', 'contacted', 'visited', 'bible_study', 'baptism_interest', 'integrated', 'inactive', 'needs_urgent_care')),
...
create table if not exists public.visits (
  ...
  visit_type text not null default 'visit' check (visit_type in ('visit', 'call', 'whatsapp', 'bible_study', 'prayer', 'pastoral_visit', 'home_visit', 'baptism_prep', 'other')),
  notes text,
...
create index if not exists members_org_care_stage_idx on public.members (organization_id, care_stage);
