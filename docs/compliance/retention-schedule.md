...
| Tasks | 24 months after completion | Secure delete | Information Officer |
| Push tokens | Until revoked/inactive + 90 days | Worker/DB delete | Technical admin |
| Audit/security logs | 12 months minimum | Secure archive/delete | Technical admin |

Deletion requests from data subjects must follow the data-subject request workflow and legal review.
